...
optional.add_argument('--ignore-extensions', type=str, default=None,help="When encrypting/decrypting you can define files extensions that will be ignored. Use: pyc,txt", dest='ignored_extensions')
